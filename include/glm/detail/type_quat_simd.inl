...
#			else
			...
			// This SIMD assimp is a politically correct way of doing this, but in every test I've tried it has been slower than
			// the final assimp below. I'll keep this here for reference - maybe somebody else can do something better...
			//
